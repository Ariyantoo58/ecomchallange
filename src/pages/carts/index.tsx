...
// import { deleteCart, getCart } from "@/libs/api-libs";
...
// 					{carts.data.map(
// 						({ prodactList, quantity, id }: any, index: number) => (
// 							<div
...
// 												src={JSON.parse(prodactList).productImage}
// 											/>
// 										</div>
// 										<div className="flex flex-col gap-1">
// 											<p className="text-lg text-gray-800 font-semibold">
// 												{JSON.parse(prodactList).productName}
// 											</p>
...
// 											${JSON.parse(prodactList).productPrice}
